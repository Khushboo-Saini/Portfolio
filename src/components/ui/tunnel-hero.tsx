...
vec2 TunnelPath(float x){
  // Perfectly straight centered tunnel pointing directly to the eye for absolute focus
  return vec2(0.0, 0.0);
}
...
interface TunnelShowcaseProps {
  showUI?: boolean;
}

export default function TunnelShowcase({ showUI = true }: TunnelShowcaseProps) {
